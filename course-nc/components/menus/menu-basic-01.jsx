...
// Styles
import './assets/css/menus.module.css'
        ...
        <Fragment>
            <FlexContainer className="nav" jcSpaceBetween bgBlue700>
                ...
                <ul className={isMobile? "nav__menu-mobile" : "nav__menu"} onClick={() => setIsMobile(false)}>
                    <Link className="nav__link" href="#"><li className="nav__li"><Typography textWhite> Inicio </Typography> </li></Link>
                    <Link className="nav__link" href="#"><li className="nav__li"><Typography textWhite> Acerca de </Typography> </li></Link>
                    <Link className="nav__link" href="#"><li className="nav__li"><Typography textWhite> Servicios </Typography> </li></Link>
                    <Link className="nav__link" href="#"><li className="nav__li"><Typography textWhite> Section </Typography> </li></Link>
                    <Link className="nav__link" href="#"><li className="nav__li"><Typography textWhite> Contactenos </Typography> </li></Link>  
                </ul>
